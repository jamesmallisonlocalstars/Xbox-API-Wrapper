...
/**
 * Xbox API Wrapper
 * For use with the XboxLeaders.com Xbox API
 *
...
class XboxApi {
	...
	public $endpoint = 'http://www.xboxleaders.com/api/';
	public $timeout = 8;
	...
	protected function http($request, $parameters = array()) {
	...
	/** Validate Gamertag **/
	protected function valid_gamertag($gamertag) {
